...
**AIC version:** **v3.4.0** (global — product, runtime API, Hermes skill, dashboard). See [CHANGELOG](./CHANGELOG.md) and [Version policy](./docs/guides/version-policy.md).

| Milestone | Status |
|-----------|--------|
| Runtime Stabilization (FIX-008 → FIX-023, IMP-024) | **COMPLETE** |
| Repository Finalization (WP-101 / WP-102) | **COMPLETE** |
| Intelligent Intake (EPIC-201) | **COMPLETE** (shipped in **v3.4.0**) |
| Production ready | **Yes** — [docs/INDEX.md](./docs/INDEX.md) |

| Component | Version |
|-----------|---------|
| AIC (global) | **3.4.0** |
| Runtime API `GET /api/version` | **3.4.0** |
| Hermes skill (`SKILL.md`) | **3.4.0** |
| Dashboard (`dashboard/package.json`) | **3.4.0** |
