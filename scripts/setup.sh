    ...
    cat > ~/.config/opencode/opencode.jsonc << EOCONFIG
{
  ...
  "provider": {
    "${PROVIDER_ID}": {
      ...
      "models": {
        "Thinker": { "name": "${MODEL_HIGH_ID}", "limit": { "context": 800000, "output": 64000 } },
        "Crafter": { "name": "${MODEL_MID_ID}", "limit": { "context": 512000, "output": 32000 } },
        "Sprinter": { "name": "${MODEL_LOW_ID}", "limit": { "context": 256000, "output": 16000 } }
      }
    }
  }
}
    ...
    cat > ~/.config/opencode/opencode.jsonc << EOCONFIG
{
  ...
  "provider": {
    "opencode": {
      ...
      "models": {
        "Thinker": { "name": "deepseek-v4-flash-free", "limit": { "context": 256000, "output": 16000 } },
        "Crafter": { "name": "deepseek-v4-flash-free", "limit": { "context": 256000, "output": 16000 } },
        "Sprinter": { "name": "deepseek-v4-flash-free", "limit": { "context": 256000, "output": 16000 } }
      }
    }
  }
}
